    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-700/50 border border-gray-600/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm sm:text-base"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-2 bg-gray-700/50 border border-gray-600/50 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm sm:text-base"
          >
      ...
      {filteredUsers.length === 0 ? (
        <div className="text-center py-16">
          <div className="relative">
            <Users className="h-16 w-16 sm:h-20 sm:w-20 text-gray-600 mx-auto mb-6" />
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-full blur-2xl"></div>
          </div>
          <h3 className="text-xl sm:text-2xl font-semibold text-gray-300 mb-3">
            No users found
          </h3>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl overflow-hidden">
          ...
          <div className="block lg:hidden">
            {filteredUsers.map((user) => (
              <div
                key={user._id}
                className="p-4 border-b border-gray-700/50 last:border-b-0 hover:bg-gray-700/20 transition-colors"
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center space-x-2">
                    <select
                      ...
                      className="px-2 py-1 bg-gray-700/50 border border-gray-600/50 rounded text-white text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    >
                      <option value="user">User</option>
                      <option value="admin">Admin</option>
                    </select>
              ...
              <tbody className="divide-y divide-gray-700/50">
                {filteredUsers.map((user) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <Shield className="h-4 w-4 mr-2 text-indigo-400 flex-shrink-0" />
                        <span
